...
export default function Login() {
    ...
    function goMicrosoft() {
        ...
        location.href = "https://login.microsoftonline.com/consumers/oauth2/v2.0/authorize?client_id=a9924c31-f355-4fe9-a7e5-bd72e140d820&response_type=code&redirect_uri=" +
